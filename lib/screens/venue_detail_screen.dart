              ...
              SliverToBoxAdapter(
                child: Column(
                  ...
                  children: [
                        ...
                        child: Row(
                          children: [
                            GestureDetector(
                              onTap: () => Navigator.push(context,
                                  MaterialPageRoute(
                                      builder: (_) => OrganizerProfileScreen(event: _eventForWidgets))),
                              child: Container(
                    ...
                    // ── Terms & Conditions — hidden (not in venue API) ──
                    // ── Reviews — hidden (not in venue API) ──
                          ...
                          onPressed: () {
                            ...
                            if (text.isEmpty) {
                              ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(
                                      content: Text('Please write a review first.')));
                              return;
                            }
